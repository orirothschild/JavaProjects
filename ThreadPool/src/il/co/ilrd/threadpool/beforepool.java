...
//            	synchronized (getLock) {
//            		while (!isDone()) {
//            			getLock.wait(TimeUnit.MILLISECONDS.convert(l, timeUnit));
//            			if (System.currentTimeMillis() - startTime >= TimeUnit.MILLISECONDS.convert(l, timeUnit)) {
//            				throw new TimeoutException("The Time has passed and no result was found");
//            			}
//            		}
//            		return result;
//				}
